...
YOLO_MODEL_PATH = os.getenv("SHOPPING_MODEL", os.path.join(_project_root, "model", "shoppingbest5.pt"))
HAND_TASK_PATH  = os.getenv("HAND_LANDMARKER_PATH", os.path.join(_project_root, "model", "hand_landmarker.task"))
